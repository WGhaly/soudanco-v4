...
CREATE TYPE "public"."payment_type" AS ENUM('user_topup', 'cash_payment', 'reward');--> statement-breakpoint
CREATE TYPE "public"."reward_status" AS ENUM('pending', 'processed', 'cancelled');--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "customer_quarterly_rewards" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"customer_id" uuid NOT NULL,
...
CREATE TABLE "payments" (
	...
	"type" "payment_type" DEFAULT 'user_topup' NOT NULL,
...
ALTER TABLE "customer_quarterly_rewards" ADD CONSTRAINT "customer_quarterly_rewards_customer_id_customers_id_fk" FOREIGN KEY ("customer_id") REFERENCES "public"."customers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "customer_quarterly_rewards" ADD CONSTRAINT "customer_quarterly_rewards_eligible_tier_id_reward_tiers_id_fk" FOREIGN KEY ("eligible_tier_id") REFERENCES "public"."reward_tiers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "customer_quarterly_rewards" ADD CONSTRAINT "customer_quarterly_rewards_payment_id_payments_id_fk" FOREIGN KEY ("payment_id") REFERENCES "public"."payments"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "customer_quarterly_rewards" ADD CONSTRAINT "customer_quarterly_rewards_processed_by_users_id_fk" FOREIGN KEY ("processed_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
