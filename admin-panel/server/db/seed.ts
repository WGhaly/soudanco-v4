...
async function seed() {
  ...
  try {
    ...
    const [juices350mlCategory] = await db.insert(categories).values({
      name: 'Juices 350ml',
      nameAr: 'عصائر 350 مل',
      slug: 'juices-350ml',
      description: 'Suntop 350ml juice bottles',
      imageUrl: `${IMAGE_BASE_URL}/orange-350ml.png`,
      sortOrder: 2,
      isActive: true,
    }).returning();

    console.log('✅ Categories created: Juices 1L, Juices 350ml');
    ...
    const productList = await db.insert(products).values([
      ...
      // ============================================
      {
        ...
        name: 'Suntop Orange',
        nameAr: 'صن توب برتقال',
        description: 'Premium Suntop orange juice, 350ml',
        descriptionAr: 'عصير صن توب برتقال فاخر، 350 مل',
        categoryId: juices350mlCategory.id,
        basePrice: '6.00',
        unit: '350 مل',
        unitsPerCase: 24,
        stockQuantity: 800,
      ...
      },
      {
        ...
        name: 'Suntop Apple',
        nameAr: 'صن توب تفاح',
        description: 'Fresh Suntop apple juice, 350ml',
        descriptionAr: 'عصير صن توب تفاح طازج، 350 مل',
        categoryId: juices350mlCategory.id,
        basePrice: '5.50',
        unit: '350 مل',
        unitsPerCase: 24,
        ...
        lowStockThreshold: 100,
        stockStatus: 'in_stock',
        imageUrl: `${IMAGE_BASE_URL}/apple-350ml.png`,
        isActive: true,
      },
      {
        sku: 'ST-BERRYMIX-350',
        name: 'Suntop Berry Mix',
        nameAr: 'صن توب خليط التوت',
        description: 'Delicious Suntop berry mix juice, 350ml',
        descriptionAr: 'عصير صن توب خليط التوت اللذيذ، 350 مل',
        categoryId: juices350mlCategory.id,
        basePrice: '6.50',
        unit: '350 مل',
        unitsPerCase: 24,
        ...
        lowStockThreshold: 100,
        stockStatus: 'in_stock',
        imageUrl: `${IMAGE_BASE_URL}/berry-mix-350ml.png`,
        isActive: true,
      },
      {
        sku: 'ST-BLACKCURRANT-350',
        name: 'Suntop Blackcurrant',
        nameAr: 'صن توب توت أسود',
        description: 'Rich Suntop blackcurrant juice, 350ml',
        descriptionAr: 'عصير صن توب توت أسود غني، 350 مل',
        categoryId: juices350mlCategory.id,
        basePrice: '6.50',
        unit: '350 مل',
        unitsPerCase: 24,
        ...
        imageUrl: `${IMAGE_BASE_URL}/black-current-350-ml.png`,
        isActive: true,
      },
      {
        sku: 'ST-MANGO-350',
        name: 'Suntop Mango',
        nameAr: 'صن توب مانجو',
        description: 'Tropical Suntop mango juice, 350ml',
        descriptionAr: 'عصير صن توب مانجو استوائي، 350 مل',
        categoryId: juices350mlCategory.id,
        basePrice: '6.50',
        unit: '350 مل',
        unitsPerCase: 24,
        ...
        lowStockThreshold: 100,
        stockStatus: 'in_stock',
        imageUrl: `${IMAGE_BASE_URL}/mango-350ml.png`,
        isActive: true,
      },
      {
        sku: 'ST-GUAVA-350',
        name: 'Suntop Guava',
        nameAr: 'صن توب جوافة',
        description: 'Fresh Suntop guava juice, 350ml',
        descriptionAr: 'عصير صن توب جوافة طازج، 350 مل',
        categoryId: juices350mlCategory.id,
        basePrice: '6.00',
        unit: '350 مل',
        unitsPerCase: 24,
        ...
        lowStockThreshold: 100,
        stockStatus: 'in_stock',
        imageUrl: `${IMAGE_BASE_URL}/guava-350ml.png`,
        isActive: true,
      },
      {
        sku: 'ST-MIXEDFRUIT-350',
        name: 'Suntop Mixed Fruit',
        nameAr: 'صن توب كوكتيل فواكه',
        description: 'Delicious Suntop mixed fruit juice, 350ml',
        descriptionAr: 'عصير صن توب كوكتيل فواكه اللذيذ، 350 مل',
        categoryId: juices350mlCategory.id,
        basePrice: '6.00',
        unit: '350 مل',
        unitsPerCase: 24,
        ...
        lowStockThreshold: 100,
        stockStatus: 'in_stock',
        imageUrl: `${IMAGE_BASE_URL}/mixed-fruit-350ml.png`,
        isActive: true,
      },
      {
        sku: 'ST-PINEAPPLE-350',
        name: 'Suntop Pineapple',
        nameAr: 'صن توب أناناس',
        description: 'Tropical Suntop pineapple juice, 350ml',
        descriptionAr: 'عصير صن توب أناناس استوائي، 350 مل',
        categoryId: juices350mlCategory.id,
        basePrice: '6.00',
        unit: '350 مل',
        unitsPerCase: 24,
        ...
        imageUrl: `${IMAGE_BASE_URL}/pinapple-350ml.png`,
        isActive: true,
      },
      {
        sku: 'ST-PINKLEMONADE-350',
        name: 'Suntop Pink Lemonade',
        nameAr: 'صن توب ليمون وردي',
        description: 'Refreshing Suntop pink lemonade, 350ml',
        descriptionAr: 'صن توب ليمون وردي منعش، 350 مل',
        categoryId: juices350mlCategory.id,
        basePrice: '6.50',
        unit: '350 مل',
        unitsPerCase: 24,
        ...
        lowStockThreshold: 100,
        stockStatus: 'in_stock',
        imageUrl: `${IMAGE_BASE_URL}/pink-lemonade-350ml.png`,
        isActive: true,
      },
      {
        sku: 'ST-DRAGONFRUIT-350',
        name: 'Suntop Frosty Dragon Fruit',
        nameAr: 'صن توب فروستي دراجون فروت',
        description: 'Exotic Suntop frosty dragon fruit juice, 350ml',
        descriptionAr: 'عصير صن توب فروستي دراجون فروت الغريب، 350 مل',
        categoryId: juices350mlCategory.id,
        basePrice: '7.00',
        unit: '350 مل',
        unitsPerCase: 24,
        ...
        lowStockThreshold: 100,
        stockStatus: 'in_stock',
        imageUrl: `${IMAGE_BASE_URL}/frosty-drangon-fruit-350-ml.png`,
        isActive: true,
      },
      {
        sku: 'ST-SPICYTANGERINE-350',
        name: 'Suntop Spicy Tangerine',
        nameAr: 'صن توب يوسفي حار',
        description: 'Unique Suntop spicy tangerine juice, 350ml',
        descriptionAr: 'عصير صن توب يوسفي حار مميز، 350 مل',
        categoryId: juices350mlCategory.id,
        basePrice: '7.00',
        unit: '350 مل',
        unitsPerCase: 24,
    ...
    const apple350 = productList.find(p => p.sku === 'ST-APPLE-350');
    const berryMix350 = productList.find(p => p.sku === 'ST-BERRYMIX-350');
    if (apple350 && berryMix350) {
      const [buyGetDiscount2] = await db.insert(discounts).values({
        ...
        description: 'Buy 3 Apple 350ml and get 1 Berry Mix 350ml free',
        type: 'buy_get',
        value: '1',
        minQuantity: 3,
        bonusQuantity: 1,
        bonusProductId: berryMix350.id,
        startDate: new Date('2025-01-01'),
        endDate: new Date('2026-12-31'),
        isActive: true,
      }).returning();
    ...
    await db.insert(orderItems).values([
      ...
      {
        orderId: order1.id,
        productId: productList[5].id, // Orange 350ml
        productName: 'صن توب برتقال 350 مل',
        quantity: 20,
        unitPrice: '5.10',
        totalPrice: '102.00',
      },
    ...
    await db.insert(orderItems).values([
      {
        orderId: order2.id,
        productId: productList[9].id, // Mango 350ml
        productName: 'صن توب مانجو 350 مل',
        quantity: 30,
        unitPrice: '5.53',
        totalPrice: '165.90',
      },
      {
        orderId: order2.id,
        productId: productList[10].id, // Guava 350ml
        productName: 'صن توب جوافة 350 مل',
        quantity: 30,
        unitPrice: '5.10',
        totalPrice: '153.00',
      },
    ...
    console.log(`   📁 Categories: 2 (Juices 1L, Juices 350ml)`);
